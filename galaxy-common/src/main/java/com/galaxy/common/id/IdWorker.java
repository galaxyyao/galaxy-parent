...
public class IdWorker {
    ...
    private static final String START_WORKING = "worker starting. timestamp left shift {}, app id bits {}, worker id " +
		    "bits {}, sequence bits {}, node id {}";
    private static final String INVALID_NODE_ID = "node Id can't be greater than %d or less than 0";
    private static final String ABNORMAL_CLOCK_MOVE = "Clock moved backwards. Refusing to generate id for %d " +
		    "milliseconds";
    ...
    public static synchronized IdWorker getInstance(int appId, int nodeId) {
        long key = Long.valueOf((appId << appIdBits) + nodeId);
